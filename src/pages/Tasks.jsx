...
// Here is the complete, amended `Tasks.jsx` file with the collapsible quick dump toggle integrated seamlessly, and no other logic or functionality altered.
...
//             onClick={() => setShowQuickDump(!showQuickDump)}
//           >
//             {showQuickDump ? "✕ Close Quick Dump" : "+ Quick Brain Dump"}
//           </button>
//         </div>
//       )}

//       {activeTab !== "add" && showQuickDump && (
//         <div className="bg-white p-3 rounded-4 shadow-sm border mb-4">
//           <QuickAddTask
//             onTaskAdded={(newTask) => {
//               handleTaskAdded(newTask);
//               setShowQuickDump(false);
//             }}
//             user={user}
//           />
//         </div>
