...
const Contact = () => {
  ...
  return (
    <div className="container mt-4">
      <div className="card border-0 rounded-4 shadow-sm p-4 mx-auto" style={{ maxWidth: "600px", backgroundColor: "#fff" }}>
        <h4 className="fw-bold text-dark text-center mb-2">Get in Touch</h4>
        
        <p className="text-muted small text-center mb-3 px-2" style={{ lineHeight: "1.5" }}>
          This application was built by a solo developer from concept to code. Feedback and collaboration are highly appreciated.
        </p>
        ...
        <form onSubmit={onSubmit} className="d-grid gap-3">
          ...
          <div>
            <label className="form-label small fw-bold text-secondary mb-1">Name</label>
          ...
          <div>
            <label className="form-label small fw-bold text-secondary mb-1">Subject</label>
            <select 
              name="subject" 
          ...
          <div>
            <label className="form-label small fw-bold text-secondary mb-1">Message</label>
            <textarea name="message" rows="4" className="form-control rounded-3 border-light-subtle shadow-none p-2.5" required></textarea>
          </div>

          <button type="submit" className="btn btn-dark rounded-pill py-2.5 fw-bold mt-1 shadow-sm">
            Send Message
          </button>
        </form>
